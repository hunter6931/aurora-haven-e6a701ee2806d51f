...
Plan low-friction recovery habits around energy and consistency.

This repository contains a complete, local-first TypeScript web application. It is generated as
an independent project, and its neutral repository name is **aurora-haven-e6a701ee2806d51f**.

## What it does

- Captures and validates recovery practice records.
